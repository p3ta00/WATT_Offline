...
![x32dbg interface with toolbars for debugging, including CPU, log, and memory map sections.](CjJR0SIihPcz.jpg)
...
![x32dbg interface showing an error requiring debugger attachment, with global argument options like ASLR and SafeSEH.](WrMSqobjzvzE.jpg)
...
![Process list interface displaying PIDs, names, titles, and paths of running applications.](DSw4cGw4MunW.jpg)
...
![Error message: 'Registration is not valid, please try again' in Free CD to MP3 Converter registration window.](JVuNiwlSd7Qq.jpg)
...
![File selection window in Free CD to MP3 Converter, displaying 'fuzz.wav' on the desktop.](mlRTnzlBz84f.jpg)
...
![Paused at INT3 breakpoint 'TLS Callback 1' in filesyncshell.dll.](RCIg6Bt6jzUP.jpg)![Toolbar with folder, refresh, stop, play, and pause icons.](AEudSRBOtfrS.jpg)
...
![Paused at first chance exception on 41414141, code C0000005, access violation.](800mfTlBEjsS.jpg)
...
![Register values with EAX as 00000000, EBX, ESI, EDI, and EIP as 41414141, and ESP pointing to a string of 'A's.](PUTG3aJO0RLQ.jpg)
...
![Memory addresses with values 41414141, pointer to SEH_Record.](hAOUTDKpvUzS.jpg)
...
![Debugger interface displaying ASCII data with hexadecimal values.](PzyYUlJwDPbc.jpg)
...
![IDLE Shell 3.9.4 showing restart of win32bof_exploit.py script.](PtOOC3nP8hxK.jpg)
...
![Toolbar with folder, refresh, stop, play, pause, download, and reset icons.](dhrKFtaxQu77.jpg)
...
![Registers with EAX as 00000000, EBX as 68463967, and ESP pointing to a string of characters.](7HebBnU91aul.jpg)
...
![Registers with EAX as 00000000, EBX as 68463967, and an edit window displaying expression 31684630 and ASCII 1hF0.](UODlR30imLob.jpg)

The hex value found in `EIP` represents the string `1hF0`. Now, we can use `ERC --pattern o 1hF0` to get the pattern offset:
![Text showing 'ERC --Pattern' with a message: 'Value found reversed at position 4112 in pattern.' Below, a command: 'ERC --pattern o 1hF0' is displayed.](XBjiwvA0P5m6.jpg)
...
![Registers EDI, ESI, EBX, ESP, EBP, and EIP overwritten with patterns at various positions in thread 8104. Command: ERC --findNRP.](PMlCncFTfVd7.jpg)
...
![Registers EAX to EDI with values, EIP highlighted as 42424242.](51QZOHrBQEYC.jpg)
...
![Byte array from 00 to FF displayed in rows. Command: ERC --bytearray.](Omr1f0dHk9xd.jpg)
...
![Memory addresses with values, including 00E8FB48 showing C0A83800 and repeated characters.](eQjUWRIqh3Vh.jpg)
...
![Registers EAX to EDI with values, ESP highlighted as 0014F974.](pYNDuW1mPYJs.jpg)
...
![Comparing memory region at 0x14F974 with file bytes, showing differences. Command: ERC --compare 0014F974 c:\Users\htb-student\Desktop\ByteArray_1.bin.](0sSSyMNUq0XQ.jpg)
...
![Byte array excluding 00, displayed in rows. Command: ERC --bytearray --bytes 0x00.](6g2taaXcrzSZ.jpg)
...
![Comparing memory region at 0x14F974 with file bytes, showing matches. Command: ERC --compare 0014F974 C:\Users\htb-student\Desktop\ByteArray_2.bin.](oGAPzJIduGXe.jpg)
...
![Grandma with walker, text: 'Just overflow the shellcode on the stack and jump to it.' Young woman replies: 'Sure grandma, let's get you to bed.'](HTG6wRhmKMZw.png)
...
![Registers EAX to EDI with values, ESP highlighted as 0014F974, EIP as 31684630.](Or8VGOGqznWQ.jpg)
...
![Process 'cdextract' with 62 modules listed, showing base, entry point, size, and security features. Command: ERC --ModuleInfo --NXCompat.](Lu48Hvcc49UG.jpg)
...
![List of modules with base addresses, including cdextract.exe, all unloaded.](VEx7PQ4EgcPd.jpg)
...
![Find Command dialog with 'jmp esp' entered.](EJ0NS1jf9zzK.jpg)

We can enter `jmp esp`, and it should show us if this file contains any of the instructions we searched for:
![Disassembly view showing 'jmp esp' at multiple addresses.](EQfdpvcucehm.jpg)
...
![Find Pattern dialog with fields for ASCII, UNICODE, UTF-8, and Hex showing '54 C3'.](p8gVNFNq9gih.jpg)

Once we do, we would find a few other addresses we can use as well:
![Pattern 54C3 found at addresses 0047D4F5, 0047D4FD, 00483D0E.](PyPB7mgrfuEL.jpg)

We can double-click any of them and confirm that it is indeed a `PUSH ESP` instruction followed by a `RET` instruction:

![Disassembly showing 'push esp' at 0047D4F5 and 'ret' at 0047D4F6.](M51DbaCp9PGc.jpg)
...
![Calculator app open in Standard mode, displaying zero.](ZqwJHKwhL2ze.jpg)
...
![Command prompt open at C:\Users\htb-student\Desktop>.](TwZgyyVPhtcj.jpg)
...
![Registers EAX to EDI with values, EIP highlighted as 41414141.](poNzxIJ4H406.jpg)
...
![ASCII pattern with command: ERC --pattern c 2000.](0GXjJqrOGEIZ.jpg)
...
![Registers EAX to EDI with values, EIP highlighted as 316A4230.](ByMgSZqOKnxs.jpg)

Now we can use `ERC --pattern o 1jB0` to calculate the exact offset, which is found at `1052` bytes:

![ERC pattern command output: Value reversed at position 1052. Command: ERC --pattern o 1jB0.](shuSSpo8gnNr.jpg)
...
![Registers EAX to EDI with values, EIP highlighted as 42424242.](AxOgZCUBXWkK.jpg)
...
![Comparing memory region at 0xA3AA30 with file bytes, showing matches. Command: ERC --compare 00A3AA30 C:\Users\htb-student\Desktop\ByteArray_1.bin.](SohvT2GNBiIV.jpg)
...
![Disassembly showing 'jmp esp' at addresses 0069D2E5, 006B2ABD, 006BDA22, 006C977D.](IcCyNEGaflZV.jpg)
