...
![Desktop with Hack The Box logo, icons for Parrot, user's Home, README, and Trash.](dS3bcZLeJ9qF.png)
...
![Laptop screen showing Parrot OS desktop with icons for Parrot, Wireshark, OWASP ZAP, Metasploit, and more, alongside a 'Parrot 4.10 Released' announcement.](o1xIUEOaLxmD.png)
...
![Network diagram showing Internet, Firewall, VPN Server, Corporate LAN, Corporate Servers, Desktops, and Remote Use.](Wd6luLc5Kaqn.png)
...
![Dashboard showing 914 online players, 1020 machine owns, 618 challenge owns, and recent activity with targets Active, Lame, and Beep.](GvHgRMh7p2ja.jpg)
...
![Parrot Terminal with user prompt showing command 'tmux'.](krkE0jIyTFAG.jpg)
...
![Parrot Terminal with user prompt ready for input.](eEGH8UrONSTL.jpg)
...
![Parrot Terminal with two panes, each showing user prompts ready for input.](5r1aGQuSKGdu.jpg)

We can also split into horizontal panes by hitting the prefix and then `[SHIFT + "]`:
![Parrot Terminal with two panes, each showing user prompts ready for input.](g3jIc2MWpdRK.jpg)
...
![Parrot Terminal displaying a configuration file with network settings and comments.](0Y8IP6lxdJ88.jpg)
...
![Parrot Terminal displaying a configuration file with network settings and comments.](zARSAFO6ZmPM.jpg)
...
![Parrot Terminal displaying a configuration file with network settings and comments.](ytpeMkwepMvm.jpg)
...
![Google search results for '1:8.2p1-4ubuntu0.1 release' showing links to OpenSSH package on Launchpad.](aJDAVx5mrt1U.png)

Another quick search reveals that the release date of this OS is April 23rd, 2020.

![Google search results for 'Ubuntu focal 20.04 release date' showing April 23, 2020, as the release date.](RQIlBze9qBZK.png)
...
![PHP Version 7.4.3 information table showing system details, build date, server API, and configuration paths.](hgGL48fmm5Aa.png)
...
![WordPress language selection screen with a list of languages and a 'Continue' button.](77JeET1pIQkI.png)
...
![Certificate details for Megabank Limited, including subject and issuer information with country, state, locality, organization, and email address.](yY4h0zxImp4T.png)
...
![Robots.txt file disallowing access to /private and /uploaded_files for all user agents.](ch1umA3mMRPR.png)

Navigating to `http://10.10.10.121/private` in a browser reveals a HTB admin login page.

![Login form with fields for username and password, and a login button.](fB4tSfc500G9.png)
...
![HTML snippet with test account credentials, meta tags, and admin login title.](UpZxcQCGpMaJ.png)
...
![Google search results for 'Windows 7 SMB exploit' showing links to EternalBlue exploit articles.](TvvLzmtFq8AG.jpg)
...
![UID, GID, and groups set to www-data.](VVMQT1UVfY4i.png)
...
![Profile overview showing rank, progress, and ownership stats.](LeoMi9QL64sh.jpg)
...
![Graph showing user, system, challenge owns, first bloods, and respect over a year; machine and challenge progress below.](CMXJTlvmalzx.jpg)
...
![Team rankings showing points, users, systems, challenges, fortresses, and endgames.](cUJ4I1G2hrEe.jpg)
...
![Dashboard showing 914 online players, 1020 machine owns, and 618 challenge owns today.](zuS1Jz2OJjPr.jpg)
...
![Tracks: Beginner, Intro to Dante, Intro to Offshore, Active Directory 101.](BlnAsaEMx3Tk.jpg)
...
![Beginner Track progress: 82% complete, includes challenges Lame, Find The Easy Pass, Templated, Weak RSA.](g9HDkgulQx2e.jpg)
...
![Machine Lab: Tenet (Medium, Linux) and Registry (Hard, Linux).](3zzw2R9yzDsh.jpg)
...
![Active machines: Doctor, Academy, Laboratory; all easy difficulty.](CycfWhq6sJTk.jpg)
...
![Academy machine: Easy difficulty, 4.6 rating, 6623 user owns, 5837 system owns.](5RQbs0P7PJ47.jpg)
...
![Active challenges: 11 Reversing, 8 Stego, 12 Misc, 12 Web.](8rx1wYiHnP7D.jpg)
...
![Context page: Entry point 10.13.37.12, progress tracker at 0%, lab reset status.](FLgNGbuUcQjc.jpg)
...
![Ascension page: Entry point 10.13.38.20, progress tracker at 0%, lab reset status.](uOsbhCWQkEC1.jpg)
...
![Dante Pro Lab overview with cowboy mascot, 14 machines, 27 flags, beginner difficulty, Level 1 penetration tester.](oxqlhg14g6Pf.jpg)
...
![Cyber Mayhem and Server Siege game modes, with icons of a hacker and a server.](z9Iw3TCWyryx.jpg)
...
![Nibbles machine details: Linux OS, Easy difficulty, 20 points, released on 13 Jan 2018, IP 10.10.10.75.](4yl6Azvif6w2.png)
...
| Ippsec Video | [https://www.youtube.com/watch?v=s\_0GcRGv6Ds](https://www.youtube.com/watch?v=s_0GcRGv6Ds) |
...
![Text 'Hello world!' displayed on a white background.](ZZzBsde5zTHW.png)

Checking the page source reveals an interesting comment.

![HTML code snippet with 'Hello world!' in bold and a comment about the /nibbleblog/ directory.](Ry8z65GuCtXD.png)
...
![Blog page titled 'Nibbles Yum yum' with no posts, categories, and links to 'Home' and 'Powered by Nibbleblog'.](nzyEfgU4HdIG.png)
...
![Login form for Nibbleblog admin area with fields for username, password, 'Remember me' checkbox, and 'Back to blog' link.](5vuouPhtUeuk.png)
...
![Directory listing of /nibbleblog/themes with folders: echo, medium, note-2, simpler, techie.](LMNHeeDzYOYN.png)
...
![Nibbleblog dashboard with options to publish, manage, and settings. Notifications show session starts and login attempts.](STD6LI3ejANZ.png)
...
![Nibbleblog plugins page showing installed plugins: Categories, Hello world, Latest posts, My image, with options to configure or uninstall.](xQIySkM0ODKN.png)
...
![Nibbleblog plugin configuration page for 'My image' with fields for title, position, caption, and file upload.](rqVys7K0cESd.png)
...
![Hack The Box dashboard with 801 online players, machine and challenge stats, and VPN connection options.](JQOrYYIo3uJN.jpg)
...
![FoxyProxy interface with options for 'Options', 'What's My IP?', and 'Log'.](jwnk43yScVUW.jpg)
...
![Hack The Box forum categories: HTB Content, Uncategorized, Tutorials, Off-topic, Site Feedback, Links, Capture the Flags, with latest topics listed.](2DYqUePDktrq.png)
...
![Discord rules: No trolling, keep content safe for work.](5V4fNZwObLUF.jpg)
