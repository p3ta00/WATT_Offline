...
![Domain-joined_Computers_NTLM_Authentication.png](yI3AfPY752aB.png)
...
![Workgroup_Computers_NTLM_Authentication.png](Z3q6vnFSbTNv.png)
...
![NTLM_Message_Fields.png](RHeqheno9IKt.png)
...
![sparkles-icon-decoration](O0OzPxAbNeKt)
...
![Oracle_Session_Attack](YSd6cHWFYT49.png)
...
![AiTM_Domain-joined_Computers_NTLM_Authentication](5oyISkdIoFsP.png)

For workgroup `NTLM` authentication, the adversary carries out the same attack:

![AiTM_Workgroup_NTLM_Authentication](jdyNaSmTaAKk.png)
...
![Phase_I_Pre-relay](ulXxNqlUUnm8.png)
...
![LLMNR_Spoofing](oC1a1UPAniJP.png)
...
![SMB_NTLMv2_Hash.gif](uVTL0k6vZL3H.gif)
...
![HTTP_NTLMv2_Hash.gif](vXrQcyFhhquM.gif)
...
![Phase_II_Relay](kXEsRvDpd8GX.png)
...
![Phase_III_Post-relay](368UQrlVXRKZ.png)
...
![NTLM_Relay_MindMap](65SbF4p1hTWc.png)
...
![SAM_Dump_Post-relay_Attack](m6yVSs4nfWkw.png)
...
![NTLM_Cross_Protocol_Relay_HTTP_over_LDAP](PCJ7djtClAJ8.png)
...
![NTLM_Relay_With_Session_Security](NA8ZEkNZnchM.png)
...
![coercion_attacks_mssql](6MnPDYRJO2FV.gif)
...
![Authentication_Coercion.png](TfAdw2ENuqvs.png)
...
![CoercerScanMode.gif](d2nQlJIr7ojA.gif)
...
![CoercerCoerceMode.gif](ZSJ2EZ3uVsEj.gif)
...
![Kerberos_RBCD_Attack.png](YPOho9JYuEO1.png)
