...
![Accessing the Command Prompt via Recovery Mode](TFPSXoc0MmL1.gif)
...
![GIF showcasing the usage of the 'cls' command in a command prompt terminal.](vKkyHDounNdm.gif)
...
![Command prompt showing directory listing and tree structure of 'C:\Users\student\Desktop' with files like 'file.txt', 'passwords.txt', and folders 'Git-Pulls', 'Notes', 'Work-Policies'.](Qk9ptlf0qbEj.png)
...
![Mind map titled 'Types of Information' with categories: General System Information, Networking Information, Basic Domain Information, and User Information, detailing elements like OS details, IP address, network resources, domain name, user accounts, and services.](wGbOhw9Fmyob.png)
...
![GIF showcasing the searching functionality and opening PowerShell.](GEFs2k1tEZBU.gif)
...
![GIF showcasing the terminal and switching between PowerShell and Command Prompt.](qKKRlGZ718ac.gif)
...
![GIF showcasing the start of Windows PowerShell ISE through the search functionality.](MaKGLSlGVgay.gif)
...
![GIF showcasing the Command Prompt and the spawn of PowerShell within it using the powershell.exe command.](66VowEAfHXWU.gif)
...
![GIF showcasing a PowerShell terminal and the usage of the Get-Help Online command.](mTNylKvJZnWC.gif)
...
![GIF showcasing the Autocomplete functionality in a PowerShell window.](8KllTYMdCR20.gif)
...
![GIF showcasing the Gal- Alias (gal) in a PowerShell window.](WNTs9rpFISiz.gif)
...
![GIF showcasing the Set-Alias command in a PowerShell window.](64KJFHpUDhhu.gif)
...
![GitHub repository page for PowerSploit, showing file list with descriptions, commit history, and project details. Highlighted files: PowerSploit.psd1 and PowerSploit.psm1, related to Invoke-PrivescAudit. Note: Project is no longer supported.](1okFFedfmNKn.png)
...
![GIF showcasing the PowerSploit.psd1 file in the Github repository.](T9nmDR0RhJzS.gif)
...
![GIF showcasing the Import-Module command in a PowerShell window and importing the PowerSploit.psd1 module.](qQFiJaFCyXvS.gif)
...
![PowerShell Gallery homepage showing search bar, statistics on unique packages, total downloads, and total packages. Includes sections for learning about the gallery and top package downloads like NetworkingDsc and PSWindowsUpdate.](1QpXsCvxqGVW.png)
...
![GIF showcasing the Install-Module command piped to the Find-Module command in a PowerShell window.](IbZ7vgGnCJgF.gif)
...
![Registry Editor showing path: HKEY_LOCAL_MACHINE\SOFTWARE\Adobe\Adobe Acrobat\10.0\Installer. Right pane displays 'DisableMaintenance' with value 1.](ukgOCec9IHwk.png)
...
![Registry Editor showing path: HKEY_LOCAL_MACHINE\SOFTWARE\Adobe\Adobe Acrobat\10.0\Installer. Right pane displays 'DisableMaintenance' with value 1.](tQFwl7fgSm9V.png)
...
![Registry Editor showing path: HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce\TestKey. Right pane displays 'access' with path to 'C:\Users\htb-student\Downloads\payload.exe'.](ChDm6XI9pvdz.png)
