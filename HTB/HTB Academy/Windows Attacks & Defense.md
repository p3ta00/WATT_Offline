...
![SSH connection](gLbZj5uR1Kzx.png)
...
![Share Folder connection](rNxwrBfNEAha.png)
...
![Roasted hashes](1MsKi0qrJpMm.png)
...
![Roasted hashes3](aux0x6msCqxz.png)
...
![Roasted hashes2](vGKoD4SJgFxA.png)
...
![Roasted hashes2](BQFJiVkJGJpq.png)
...
![Roasted hashes2](i9KuBg4Cn9QP.png)
...
![Roasted hashes2](YFaqGnQt2jxg.png)
...
![Roasted hashes](mYJSgSvi2Zah.png)
...
![Roasted hashes](nmPk934wp8Vg.png)
...
![Roasted hashes](FJ63PcVLHx7F.png)
...
![Roasted hashes](KMAr7AdJksyT.png)
...
![Roasted hashes](os0ItbJo2FZG.png)
...
![Roasted hashes](vaMvwVF1Tqde.png)
...
![Roasted hashes](E1XsEtRLP30Y.png)
...
![Roasted hashes](ZXN1JZDkRKkf.png)
...
![Roasted hashes](Yv6JFXpdRYlh.png)
...
![Roasted hashes](nw4kJGcIIzXO.png)

- `4771`

![Roasted hashes](nB9fpNu3TJWz.png)

- `4776`

![Roasted hashes](P15sxrzaMAn4.png)
...
![Roasted hashes](HN8p64N63aZX.png)
...
![Roasted hashes](hufijMlUeBVF.png)
...
![invoke-sharefinder](2etubyZiG8zI.png)
...
![invoke-sharefinder](ryNQzPuAtrtq.png)
...
![invoke-sharefinder](ikGtIJLjaAWy.png)
...
![invoke-sharefinder](p28iVX2pEsfX.png)
...
![invoke-sharefinder](IPgRlbATR2gP.png)
...
![invoke-sharefinder](9k4CaWH2xfre.png)
...
![Honey user - Failed logon 4625](Sc1mluynIXWa.png)

- `4771`

![Honey user - Failed logon 4771](ZQ562yhaFEgf.png)

- `4776`

![Honey user - Failed logon 4776](Fo37IxKzux7k.png)
...
![Creds in Description](YbehF9i8gwQv.png)
...
![Creds in Description](I1qHtqtd7f6X.png)
...
![Honey user - Failed logon 4625](x0p6b55kDBRp.png)

- `4771`

![Honey user - Failed logon 4771](1sI1xDhhZxNY.png)

- `4776`

![Honey user - Failed logon 4776](b34f5J5rTzGG.png)
...
![Creds in Description](mxwAQ3c5VRUC.png)
...
![Creds in Description](Jvgv3Dzf6uIT.png)
...
![Creds in Description](YNkPXbL0Idwp.png)
...
![Creds in Description](nJBciiTmnCdV.png)
...
![Golden Ticket](iSOgtUwIzedq.png)
...
![Golden Ticket](Oe0peC5uN2jU.png)
...
![Golden Ticket](jYznfpjF4OjA.png)
...
![Golden Ticket Logon](jBxP8lU2KAmg.png)
...
![Golden Ticket TGS1](x4GzEcZers06.png)

## Ticket 2:

![Golden Ticket TGS1](tsn80gt2MKpa.png)
...
![Get Trusted for Authentication](qradGJo6hASC.png)
...
![Obtain ticket](fXjl0LcWxhQA.png)
...
![Enter PSSession](lBeYRvqAZuOr.png)
...
![Successful logon](hpg9bQjsu8O4.png)
...
![NTLMRelay starting](SEobKUk19d5c.png)
...
![Prevent via registry key](v3ixJs6pbsas.png)
...
![Find Unconstrained Delegation](nHgsgMK7aPlp.png)
...
![Rubeus Monitor TGTs](FTeInBdNjWA9.png)
...
![Coercer to DC1](23ALKmBujLQh.png)
...
![Sharphound execution](F6hL7NCBqAKG.png)
...
![BloodHound analysis](9ERnNS0cmnz0.png)
...
![Anni was modified](eFxxw3KTH65y.png)
...
![Server01 was modified](fBw7WjvPpNlp.png)
...
![Anni was modified](45cJOFZs0z4F.png)
...
![Certify scan for vulnerable templates](xpVmLs2HxHhI.png)
...
![Certify request certificate](shAzrWMsQeoI.png)
...
![Convert PEM to PFX](kFCp9ZAhEJXh.png)
...
![Get TGT for Administrator](4J7TI8IPJXMx.png)
...
![Directory listing of C$ on DC1](sXAc5oTF1gMb.png)
...
![Bob requests certificate](IDG3O3LBXYWI.png)
...
![Bob issued certificate](lEom1OuuoQRZ.png)
...
![Bob issued certificate](tuHpT6cDE8Vt.png)
...
![Logon with certificate](w6WsHIhelSei.png)
...
![Starting NTLMRelay](TfhGbnvUNdT7.png)
...
![NTLMRelay certificate obtained](TaV6beMlm2h6.png)
...
![Rubeus TGT for DC2](liS88DkBPc30.png)

![Rubeus TGT for DC2](FIjeKqGfLbhL.png)
...
![DC2 certificate request](yVTCi6zmZaL0.png)

![DC2 certificate issue](a7KNd55JkRfe.png)
...
![DC2 logon with certificate](h3jfLKLtnpQz.png)
...
![DC2 DCSync logon event](gkk0SJzVCVrw.png)
