...
![](EHImBnSlAsyn.png)![](qdEYWbRoGA9v.png)
...
- **Cobalt Strike Load by rundll32**![](vEVK2Z2hjOfY.png)

- **Cobalt Strike Named Pipe**![](kx0X0cth1jM8.png)
...
- **UAC (User Account Control) Bypass/Privilege Escalation by Abusing fodhelper.exe**![](x07olVQvoawR.png)

![](7E8x2iAMqV3Y.png)

[https://pentestlab.blog/2017/06/07/uac-bypass-fodhelper/](https://pentestlab.blog/2017/06/07/uac-bypass-fodhelper/)

- **LSASS Access**![](EiQYArvnyKvQ.png)

- **Windows PowerShell Execution**![](oA0dFdkLYKwH.png)
