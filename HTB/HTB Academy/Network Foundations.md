...
![GIF showcasing the process to launch the parrot terminal.](is9Or8QINtPS.gif)
...
![GIF showcasing the connection on an SSH service running on port 8888 through Command Prompt.](cZGAEgXUI7WG.gif)
