...
![Local Process Injection](70DnTFXkV84T.png)
...
![Self process injection](6M570eGCj8xE.gif)
...
![Self process injection](Bs681LVwOEb2.png)
...
![Stack call trace](Y6Vd4q78nUeL.png)
...
![Stack call trace](XvXsu2z4cCJE.png)
...
![Stack call trace](a4ODr6dHKpHJ.png)
...
![Stack call trace](r9FvZQ7wQbVy.png)
...
![Classic Injection](lpcEnz0KWm23.png)

The following demo showcases the workflow:

![Classic Injection](oBqcFryD283b.gif)
...
![Process Creation Events](m8tNc6SY2DzI.png)
...
![Process Access Events](fK71Dz5nMkjp.png)
...
![Thread creation Events](ugaGZHyHs6i3.png)
...
![Thread creation Events](5TaCCLrXALeb.png)
...
![Thread Execution Hijacking](JeTLzNoMWk3I.png)
...
![Thread Execution Hijacking](BViPvAJMKV9Y.png)
...
![Thread Execution Hijacking](hUuptwqxLATM.png)
...
![Thread Execution Hijacking](q3kPk8NnzNkw.png)
...
![Thread Execution Hijacking](QzF5e4udmy4h.png)

The code then suspends the thread using `SuspendThread`.

![Thread Execution Hijacking](yPu2umNEZ7eH.png)
...
![Thread Execution Hijacking](m4BsTAllkdrr.png)
...
![Thread Execution Hijacking](ZoQHeQYnvT1D.png)

Below, we can see how this is represented in the disassembler:

![Thread Execution Hijacking](WpIrbrUMPYFQ.png)
...
![Thread Execution Hijacking](uJpQZmGdE0ds.png)
...
![Thread Execution Hijacking](9bSMEIZXZaPC.png)
...
![Thread Execution Hijacking](9JUr5AIfk2xN.png)
...
![APC Injection](Ugy6wK5qCrxx.png)
...
![APC Injection](RvbG0SHUqqTx.png)
...
![APC Injection](oXuSDNoxbUrp.png)
...
![APC Injection](SakgmWTQwM2G.png)
...
![APC Injection](5brKOAl9JXZt.png)
...
![Section-Mapping](MA3tmYrhWLrp.png)
...
![Section-Mapping](6xHR8wKkMbgp.png)
...
![Section-Mapping](oW1H4bX1SO6Y.png)
...
![Section-Mapping](DIuYRLqP119l.png)
...
![Section-Mapping](BXfeBNqlRrpI.png)
...
![Section-Mapping](kC4DgvLRaRQh.png)
...
![Section-Mapping](i0nJdcpH5ELR.png)
...
![Section-Mapping](cgK07SdKeJPS.png)
...
![Section-Mapping](RiCLYdCbMD1N.png)
...
![Section-Mapping](2hvpz39fTriP.png)
...
![Section-Mapping](WyuqlISKx7fE.png)
...
![Section-Mapping](5frMUPlP6zcI.png)
...
![Section-Mapping](CFoAG08MJApN.png)
...
![Section-Mapping](TlK1hSrUuVkG.png)
...
![Section-Mapping](INLVz0sKU4s5.png)
...
![Section-Mapping](ONS3Alainz7t.png)
...
![ProcessHollow](GHReS6dCAzml.png)
...
![ProcessHollow](yGmIwTDCU0Lc.png)
...
![ProcessHollow](Gd7qtQhqyBkj.gif)
...
![ProcessHollow](lcDrxH3OZV2v.png)
...
![ProcessHollow](Nt0gTy9yMDtJ.png)
...
![ProcessHollow](jxBeO0Bo2Giw.png)
...
![ProcessHollow](0htXN0BvlxxU.png)
...
![ProcessHollow](9ZPFpnkbOBIP.png)
...
![ProcessHollow](GAZNfAequw45.png)
...
![ProcessHollow](oTBBfJovyPD5.png)
...
![ProcessHollow](OUd2KweqExnV.png)
...
![ProcessHollow](F9TxMZ4zfO0B.png)
...
![ProcessHollow](QCYySSY0K74k.png)
...
![RDLL](Dhw9CvyQter9.png)

This can be checked in the DebugView output.

![DBGVIEW](F2jnpshdaXsf.png)
