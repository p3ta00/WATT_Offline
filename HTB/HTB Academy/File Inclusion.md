...
![Webpage showing 'Inlane Freight' with a language dropdown menu open, displaying options for 'English' and 'Spanish'.](bod3yzuwkSTW.png)

If we select a language by clicking on it (e.g. `Spanish`), we see that the content text changes to spanish:
![Shipping containers stacked at a port with cranes in the background, illustrating the history and industry of container shipping.](9l3kBpV5wsCu.png)
...
![Shipping containers and cranes at a port, with a list of system user accounts displayed.](91AiPskdqHRf.png)
...
![Shipping containers and cranes at a port with PHP include error messages displayed.](WkW4Oe37mz2A.png)
...
![Shipping containers and cranes at a port with a list of system user accounts displayed.](BSOTF32RllDy.png)
...
![Shipping containers and cranes at a port with a PHP include error message displayed.](Gj0hI23Uf8Pr.png)
...
![Shipping containers and cranes at a port with a list of system user accounts displayed.](QxLHNgh4q6g1.png)
...
![Shipping containers and cranes at a port with PHP include error messages displayed.](Bmf1OimzkDHV.png)
...
![Shipping containers and cranes at a port with PHP include error messages displayed.](KbbppmGfg11q.png)
...
![Shipping containers and cranes at a port with a list of system user accounts displayed.](x2YlQaDFZXUA.png)
...
![burp_url_encode](SsvVOC2PqUE0.jpg)
...
![Burp Suite Decoder showing path traversal input '../../etc/passwd' and its URL-encoded output.](bKsGXi1cAkDZ.png)
...
![Shipping containers and cranes at a port with a list of system user accounts displayed.](HMxNo2cCfLfS.png)
...
![Shipping containers and cranes at a port.](hYVxQoYdAjzj.png)
...
![Shipping containers and cranes at a port with encoded text displayed.](lgw8dH8uL5QK.png)
...
![Shipping containers and cranes at a port with a PHP notice about an undefined variable.](HnXbfMPxfJLq.png)
...
![Shipping containers and cranes at a port with user and PHP error information displayed.](I0DZdH9FAqWq.jpg)
...
![Shipping containers and cranes at a port with user data information displayed.](ax3hKRm3aiFA.jpg)
...
![Shipping containers and cranes at a port with user data information displayed.](8aq8K9z8nO9q.jpg)
...
![Shipping containers and cranes at a port with NT AUTHORITY\IUSR information displayed.](aVsFY7pz0snz.png)
...
The [File Upload Attacks](/module/details/136) module covers different techniques on how to exploit file upload forms and functionalities. However, for the attack we are going to discuss in this section, we do not require the file upload form to be vulnerable, but merely allow us to upload files. If the vulnerable function has code `Execute` capabilities, then the code within the file we upload will get executed if we include it, regardless of the file extension or file type. For example, we can upload an image file (e.g. `image.jpg`), and store a PHP web shell code within it 'instead of image data', and if we include it through the LFI vulnerability, the PHP code will get executed and we will have remote code execution.
...
![Profile image upload interface with a successful upload message.](SxzHQQ0dPJYD.jpg)
...
![Shipping containers and cranes at a port with user data information displayed.](lgh1n2GXXgDn.jpg)
...
![Shipping containers and cranes at a port with user data and a PHP notice about an undefined variable.](OwqhrpWTD9Yd.png)
...
![Shipping containers and cranes at a port with user data information displayed.](uhaOUQSN37Bx.jpg)
...
![Shipping containers and cranes at a port with browser console displaying PHP session information.](aN8ZG4mWxWUY.png)
...
![Shipping containers and cranes at a port with PHP notice about an undefined variable.](RxXjjHyQ3HYe.png)
...
![Shipping containers and cranes at a port with PHP notice about an undefined variable.](BcQaCIpnYLxt.png)
...
![Shipping containers and cranes at a port with server log entries displayed.](ytajXrkmF1N5.png)
...
![HTTP request and response showing Apache log poisoning with PHP notice about an undefined variable.](1xE69WmfA5Zi.png)
...
![HTTP request and response showing Apache log poisoning with PHP code execution using system command.](NFLabmXC16mc.png)
