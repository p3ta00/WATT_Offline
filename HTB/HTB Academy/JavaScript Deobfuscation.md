...
![Secret Serial Generator: This page generates secret serials.](VZhGQhsd4smV.jpg)
...
![HTML code snippet for a webpage titled 'Secret Serial Generator' with CSS for full-page width and height.](BHL6AvtfarDJ.jpg)
...
![JavaScript deobfuscation module with options for fast decode and special characters, showing obfuscated code.](9nETF7utJHCR.jpg)
...
![Console output showing 'HTB JavaScript Deobfuscation Module' log message and version 2.1.2.](MvKG03ASJQwQ.jpg)
...
![JavaScript minification tool showing input code and minified output.](Y1mR5k1VUGRy.jpg)
...
![JavaScript deobfuscation tool with options for fast decode and special characters, showing obfuscated code.](7O73rAQiQIUE.jpg)
...
![Console output showing obfuscated JavaScript code and version 2.1.2.](5nHL4BzUmocn.jpg)
...
![JavaScript obfuscation tool with options for compact code, string array manipulation, and sourcemaps.](jBImTdsGero3.jpg)

Now, we can paste our code and click `obfuscate`:
![JavaScript code input area with 'Obfuscate' button.](yDv5MVftnNRH.jpg)
...
![Obfuscated JavaScript code output with 'HTB JavaScript Deobfuscation Module' message.](F6hF6TVRGTGK.jpg)
...
![Code editor showing JavaScript file 'secret.js' with regex replacement code.](v1P5r06vtJSw.jpg)
...
![Code editor displaying obfuscated JavaScript function using eval.](OR1i4q4ncXRW.jpg)

![Obfuscated JavaScript code using eval and regex replacement.](F7nwBx99TqD1.jpg)
...
![Obfuscated JavaScript code with functions for generating and sending serials.](njfwUvO84KyR.jpg)
