...
![Diagram of Active Directory Organization showing a pyramid structure. Top: Domain Policy for enterprise-wide policy and licensing. Middle: Group Policy Object managing application portfolio and settings. Bottom: Marketing and Sales documents within Active Directory OU. Left: Active Directory Server. Right: Application Library and File Share.](https://academy.hackthebox.com/storage/modules/74/whyad5.png)[Source](https://dbaontap.com/2016/11/25/oem13c-roles-ad-groups/active-directory/)
...
![Diagram of Forest A and Forest B. Forest A: Parent Domain with three OUs, Child Domain with three OUs. Forest B: Domain with three OUs.](https://academy.hackthebox.com/storage/modules/74/ad_forests.png)
...
![Diagram of Active Directory Forests & Domains. Left: inlanefreight.local with subdomains corp, dev, wh.corp, and admin.dev. Right: freightlogistics.local with subdomains corp, dev, and admin.dev.](https://academy.hackthebox.com/storage/modules/74/ilflog2.png)
...
![Diagram of Active Directory structure showing Distinguished Name (DN) and Relative Distinguished Name (RDN) for inlanefreight.local. Includes Users, Sales, and Managers OUs, leading to user BJones. Notes: DN must be unique in the directory, RDN must be unique in an OU.](https://academy.hackthebox.com/storage/modules/74/dn_rdn2.png)
...
![Icons representing Active Directory Objects: Domain, Computer, OU, Groups, User, and Printers.](https://academy.hackthebox.com/storage/modules/74/adobjects.png)
...
![Diagram of DNS request process: User requests inlanefreight.com, DNS server provides IP 134.209.24.248, user makes HTTP request to IP, server responds.](https://academy.hackthebox.com/storage/modules/74/dns_highlevel.png)
...
![Email from Bucky Barnes to Helpdesk requesting tasks: add new hires to AD, remove inactive users, unlock Adam Masters' account, create security group and OU, validate DNS records, and apply Group Policy.](https://academy.hackthebox.com/storage/modules/74/helping-out.png)
...
![Service ticket for Adam Masters: Account locked out. Priority 2 - Medium, Impact/Urgency: Low/Medium. Notes mention repeated lockouts after incorrect password entries.](https://academy.hackthebox.com/storage/modules/74/troubleticket.png)
...
![Active Directory Users and Computers interface showing the creation of a new user under the Corp organizational unit. Context menu highlights 'New' and 'User' options.](https://academy.hackthebox.com/storage/modules/74/add-user1.png)

1\. Right click on "IT", Select "New" > "User".


![New User creation form for Andromeda Cepheus in INLANEFREIGHT.LOCAL/Corp/Employees/HQ-NYC/IT. Fields include first name, last name, user logon name 'acepheus'.](https://academy.hackthebox.com/storage/modules/74/add-user2.png)

2\. Add the users First and Last name, set the "User Logon Name:" as \`acepheus\` and then hit Next.


![New User password setup form for INLANEFREIGHT.LOCAL/Corp/Employees/HQ-NYC/IT. Password fields filled, 'User must change password at next logon' checked.](https://academy.hackthebox.com/storage/modules/74/add-user3.png)

3\. Set a password of \`NewP@ssw0rd123!\`and check the box for "User must change password at next login".


![New User creation summary for Andromeda Cepheus in INLANEFREIGHT.LOCAL/Corp/Employees/HQ-NYC/IT. User logon name: acepheus. User must change password at next logon.](https://academy.hackthebox.com/storage/modules/74/add-user4.png)

4\. If all attributes look correct, select "Finish" in the last window


![Active Directory Users and Computers interface showing user Andromeda Cepheus in the IT organizational unit under INLANEFREIGHT.LOCAL/Corp/Employees/HQ-NYC.](https://academy.hackthebox.com/storage/modules/74/add-user5.png)
...
![Active Directory Users and Computers interface showing the context menu for the Employees organizational unit. 'Find' option is highlighted.](https://academy.hackthebox.com/storage/modules/74/del-user1.png)

1\. Right click on the "Employees OU" and select "find".


![Find Users, Contacts, and Groups interface showing search for 'Paul Valencia' in Employees. Result: Paul Valencia, User.](https://academy.hackthebox.com/storage/modules/74/del-user2.png)

2\. Type in the username you wish to search for, in this case "Paul Valencia" and hit "Find Now".


![Find Users, Contacts, and Groups interface showing search for 'Paul Valencia' in Employees. Context menu with 'Delete' option highlighted for Paul Valencia, User.](https://academy.hackthebox.com/storage/modules/74/del-user3.png)

3\. Right click on the user and select delete.


![Confirmation dialog in Active Directory Domain Services asking to delete user 'Paul Valencia' with 'Yes' and 'No' options.](https://academy.hackthebox.com/storage/modules/74/del-user4.png)
...
![Active Directory Users and Computers interface showing context menu for user Adam M. 'Reset Password' option is highlighted.](https://academy.hackthebox.com/storage/modules/74/unlock-1.png)
...
![Active Directory Users and Computers interface showing context menu for creating a new Organizational Unit under Employees. 'New' and 'Organizational Unit' options are highlighted.](https://academy.hackthebox.com/storage/modules/74/new-ou1.png)

1\. From within the IT OU, Right click and select "New" > "Organizational Unit"


![Active Directory Users and Computers interface showing creation of a new Organizational Unit named 'Security Analysts' under INLANEFREIGHT.LOCAL/Corp/Employees/HQ-NYC/IT. 'Protect container from accidental deletion' is checked.](https://academy.hackthebox.com/storage/modules/74/new-ou2.png)
...
![Active Directory Users and Computers interface showing context menu for creating a new Group under Security Groups. 'New' and 'Group' options are highlighted.](https://academy.hackthebox.com/storage/modules/74/new-group1.png)

1\. Right click on our new OU \`Security Analysts\` and select "New > Group". A popup window should appear.


![Active Directory interface showing creation of a new group named 'Security Analysts' in INLANEFREIGHT.LOCAL/Corp/Employees/HQ-NYC/IT. Group scope set to 'Domain local' and type to 'Security'.](https://academy.hackthebox.com/storage/modules/74/new-group2.png)
...
![Active Directory interface showing context menu for user Andromeda Cepheus. 'Add to a group' option is highlighted.](https://academy.hackthebox.com/storage/modules/74/user-group1.png)

1\. Right click on the user and select "Add to a group"


![Select Groups dialog in Active Directory. 'Security' entered in object names field, 'Check Names' clicked. 'Security Analysts' group selected from matching names.](https://academy.hackthebox.com/storage/modules/74/user-group2.png)

2\. Enter a full or partial group name in the search box and hit "Check Names".


![Select Groups dialog in Active Directory. 'Security Analysts' entered in object names field, 'OK' button highlighted.](https://academy.hackthebox.com/storage/modules/74/user-group3.png)
...
![Active Directory Users and Computers interface showing context menu for Security Analysts Control GPO. 'Edit' option is highlighted.](https://academy.hackthebox.com/storage/modules/74/edit-policy.png)

1\. Right-click the GPO we wish to modify and select "Edit". This will bring up the Group Policy Configuration Editor window.


![Group Policy Management Editor showing User Configuration for Removable Storage Access. 'All Removable Storage classes: Deny all access' is highlighted and not configured](https://academy.hackthebox.com/storage/modules/74/storage-1.png)
...
![Group Policy Management Editor showing Removable Storage Access settings. 'All Removable Storage classes: Deny all access' is highlighted with 'Edit' option selected.](https://academy.hackthebox.com/storage/modules/74/storage-2.png)

3\. Right click the setting and select "Edit".


![Group Policy setting for 'All Removable Storage classes: Deny all access' is enabled. Options to apply or cancel changes are highlighted.](https://academy.hackthebox.com/storage/modules/74/storage-3.png)

4\. Check the radial button to enable the setting, hit "Apply" and then "OK".


![Group Policy Management Editor showing Removable Storage Access settings. 'All Removable Storage classes: Deny all access' is enabled.](https://academy.hackthebox.com/storage/modules/74/storage-4.png)

5\. We can now see that our Policy setting is set to Enbled. Once we push policy to the domain, it will take effect.


![Group Policy Management Editor showing User Configuration for System settings. 'Prevent access to the command prompt' is highlighted and not configured.](https://academy.hackthebox.com/storage/modules/74/cmd-1.png)

6\. Next we are modifying the policy for Command Prompt access. Move to the System hive under User Configuration.


![Group Policy Management Editor showing User Configuration for System settings. 'Prevent access to the command prompt' is highlighted with 'Edit' option selected.](https://academy.hackthebox.com/storage/modules/74/cmd-2.png)

7\. Right click and Edit the setting for "Prevent access to the command prompt".


![Group Policy setting for 'Prevent access to the command prompt' is disabled. Options to apply or cancel changes are highlighted.](https://academy.hackthebox.com/storage/modules/74/cmd-3.png)
...
![Group Policy Management Editor showing System settings. 'Prevent access to the command prompt' is disabled.](https://academy.hackthebox.com/storage/modules/74/cmd-4.png)
...
![Group Policy Management Editor showing Computer Configuration for Security Options. 'Interactive logon: Message text for users attempting to log on' is highlighted and not defined.](https://academy.hackthebox.com/storage/modules/74/banner-1.png)
...
![Security policy setting for 'Interactive logon: Message text for users attempting to log on' is defined. Warning message about restricted access is displayed. 'OK' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/banner-2.png)
...
![Security policy setting for 'Interactive logon: Message title for users attempting to log on' is defined as 'Computer Access Policy'. 'OK' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/banner-3.png)
...
![Group Policy Management Editor showing Computer Configuration for Password Policy. Policies like Enforce password history, Maximum password age, and others are not defined.](https://academy.hackthebox.com/storage/modules/74/password-1.png)
...
![Group Policy Management Editor showing 'Minimum password length' policy set to 10 characters. 'Define this policy setting' is checked. 'OK' and 'Apply' buttons are highlighted.](https://academy.hackthebox.com/storage/modules/74/password-2.png)
...
![Group Policy setting for 'Password must meet complexity requirements' is defined and enabled. 'OK' and 'Apply' buttons are highlighted.](https://academy.hackthebox.com/storage/modules/74/password-3.png)
...
![Group Policy Management Editor showing 'Enforce password history' policy set to remember 5 passwords. 'Define this policy setting' is checked. 'OK' and 'Apply' buttons are highlighted.](https://academy.hackthebox.com/storage/modules/74/password-4.png)
...
![Group Policy Management Editor showing 'Minimum password age' properties. Suggested change: Minimum password age set to 7 days, Maximum password age suggested to 30 days. 'OK' and 'Apply' buttons are highlighted.](https://academy.hackthebox.com/storage/modules/74/password-5.png)
...
![System information for Windows 10 Pro showing processor, RAM, system type, and computer name. 'Change settings' option is highlighted.](https://academy.hackthebox.com/storage/modules/74/join-domain1.png)

1\. From the control panel, open up system properties for the pc. Click on Change Settings in the Computer name section.


![System Properties window showing Computer Name tab. Fields for computer description, full computer name 'ACADEMY-IAD-TEMPJ', and workgroup 'WORKGROUP'. 'Change' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/join-domain2.png)

2\. In this window, select the Change button beside "rename this computer or change its domain."


![Computer Name/Domain Changes window showing computer name 'ACADEMY-IAD-TEMPJ' and domain 'INLANEFREIGHT.LOCAL'. 'OK' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/join-domain3.png)

3\. Enter the domain you wish to join the host to. (INLANEFREIGHT.LOCAL) Hit OK.


![Windows Security dialog for Computer Name/Domain Changes. Domain: INLANEFREIGHT.LOCAL\htb-student_adm with password field. 'OK' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/join-domain4.png)

4\. Enter the domain administrator credentials provided to join the host to the domain.


![Computer Name/Domain Changes confirmation dialog. Message: 'Welcome to the INLANEFREIGHT.LOCAL domain.' 'OK' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/join-domain5.png)
...
![Active Directory Users and Computers interface showing Computers under INLANEFREIGHT.LOCAL. Context menu for ACADEMY-1 with 'Move' option highlighted.](https://academy.hackthebox.com/storage/modules/74/moveou1.png)

1\. Looking in the Computers OU, select our newly joined host and right click it. Select the option to "Move"


![Active Directory Users and Computers interface showing the 'Move' dialog for ACADEMY-1. 'Computers' container is highlighted for selection.](https://academy.hackthebox.com/storage/modules/74/moveou2.png)

2\. In the popup, drill down to the Security Analysts OU.


![Move object dialog in Active Directory. 'Corp' and 'Security Analysts' containers are highlighted for selection. 'OK' button is highlighted.](https://academy.hackthebox.com/storage/modules/74/moveou3.png)

3\. Select the Security Analysts OU and hit OK.


![Active Directory Users and Computers interface showing ACADEMY-IAD-TEM computer under INLANEFREIGHT.LOCAL in the Computers container.](https://academy.hackthebox.com/storage/modules/74/moveou4.png)
