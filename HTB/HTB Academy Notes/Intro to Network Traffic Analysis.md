...
![Termshark interface showing network packet details with a help overlay listing keyboard shortcuts for navigation and filtering.](https://academy.hackthebox.com/storage/modules/81/termshark-help.png)
...
![Wireshark capture showing HTTP and TCP traffic between IPs 10.1.1.101 and 10.1.1.1, with details on GET requests and packet data in hex and ASCII.](https://academy.hackthebox.com/storage/modules/81/wireshark-interface.png)
...
![Wireshark capture showing HTTP and TCP traffic between IPs 10.1.1.101 and 10.1.1.1, with details on GET requests and packet data in hex and ASCII.](https://academy.hackthebox.com/storage/modules/81/wireshark-menu.png)
...
![GIF showcasing the capture options.](https://academy.hackthebox.com/storage/modules/81/first-capture-ws.gif)
...
![Toolbar with menu options and icons for file operations, search, and filter application.](https://academy.hackthebox.com/storage/modules/81/wireshark-toolbar.jpg)
...
![Wireshark capture filters list with expressions for filtering by Ethernet, IP, TCP, UDP, and specific ports.](https://academy.hackthebox.com/storage/modules/81/capture-filter-list.png)
...
![Wireshark capture options showing interfaces, promiscuous mode enabled, and TCP filter applied.](https://academy.hackthebox.com/storage/modules/81/how-to-add-cap.png)
...
![Wireshark interface showing filtered TCP traffic between IPs 162.159.134.234 and 192.168.86.211, with protocols TLSv1.2 and TCP.](https://academy.hackthebox.com/storage/modules/81/display-filter.png)
...
![Wireshark capture showing ARP and TCP packets between IPs 10.129.43.4 and 10.129.43.29, with conversation statistics below.](https://academy.hackthebox.com/storage/modules/81/guided-conversations.png)
...
![Wireshark Protocol Hierarchy Statistics showing percentages and bytes for various protocols, including TCP and UDP.](https://academy.hackthebox.com/storage/modules/81/guided-proto.png)
...
![Wireshark interface with no packets displayed, showing Remote Desktop Protocol filter applied.](https://academy.hackthebox.com/storage/modules/81/enc-rdp.png)
...
![Wireshark capture showing TCP and TLSv1.2 packets between IPs 10.129.43.27 and 10.129.43.29, filtered by port 3389.](https://academy.hackthebox.com/storage/modules/81/3389.png)
...
![Wireshark Preferences window showing TLS settings, including RSA key list and options for reassembling TLS records.](https://academy.hackthebox.com/storage/modules/81/import-ws.png)
...
![Wireshark TLS Decrypt settings showing IP 10.129.43.29, port 3389, protocol tpkt, and key file path.](https://academy.hackthebox.com/storage/modules/81/import-steps.png)

When filtering once again on RDP, we should see some traffic in the display.

#### RDP In The Clear

![Wireshark capture showing RDP packets between IPs 10.129.43.27 and 10.129.43.29, detailing various PDU types and actions.](https://academy.hackthebox.com/storage/modules/81/rdp-clear.png)
...
![Wireshark capture showing TCP and TLSv1.2 packets between IPs 10.129.43.27 and 10.129.43.29, filtered by port 3389, with details on ignored records and a cookie value.](https://academy.hackthebox.com/storage/modules/81/rdp-user.png)
