...
![image](https://academy.hackthebox.com/storage/modules/28/osint-structure4.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/emails.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/news3.png)
...
For example, we may find a post describing a specific application in detail (i.e., how to install it, how to work with it, and more.)
...
![img](https://academy.hackthebox.com/storage/modules/28/infra-emails-google-dev.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/haveibeenpwned.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/infra-3rd-parties.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/securitytrails.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/infra-3rd-parties-google.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/infra-networks.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/cn_twitter.png)
...
We cannot say whether `company-specific` information has been shared, but we should investigate the employee more in detail to prove or disprove this fact.

#### Facebook - Sharing Paid Trainings

![image](https://academy.hackthebox.com/storage/modules/28/cn_fb.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/workspace.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/infra-techs.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/builtwith.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/tech_login.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/leaks.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/wayback.png)

#### Archive.fo

![image](https://academy.hackthebox.com/storage/modules/28/archive.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/wayback_robots.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/wayback_urls.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/wayback_news.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/leaks-pastebin.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/leaks-pastebin2.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/leaks_calendar.png)
...
![image](https://academy.hackthebox.com/storage/modules/28/sm_gitlab.png)

#### Github - Passwords

![image](https://academy.hackthebox.com/storage/modules/28/sm_company_repo2.png)
...
From the previous `metadata`, we could determine the version of `Acrobat`. There exist also databases where already known vulnerabilities are published. Such databases are, but not limited to:
...
![image](https://academy.hackthebox.com/storage/modules/28/breaches_exploitdb.png)
...
![img](https://academy.hackthebox.com/storage/modules/28/intelligence1.png)
