...
![GIF showcasing the usage of the Remote Desktop Connection application.](https://academy.hackthebox.com/storage/modules/49/UsingRemoteDesktopConnection.gif)
...
![GIF showcasing the saving of credentials in the Remote Desktop Connection application.](https://academy.hackthebox.com/storage/modules/49/SavingRDPConnections.gif)
...
![GIF showcasing the usage of the xfreerdp tool on the Linux workstation.](https://academy.hackthebox.com/storage/modules/49/ConnectingwithXfreerdp.gif)
...
![Diagram of file sharing using SMB: A client sends an SMB request to a server, which responds. The server accesses file systems and printers, displaying a file directory.](https://academy.hackthebox.com/storage/modules/49/smb_diagram.png)
...
![Windows desktop with a context menu open, showing options for creating new folders, shortcuts, and documents.](https://academy.hackthebox.com/storage/modules/49/creating_directory.png)

We are going to use the `Advanced Sharing ` option to configure our share.

#### Making the Folder a Share

![Windows desktop showing 'Company Data Properties' with advanced sharing settings, including share name, user limit, and comments.](https://academy.hackthebox.com/storage/modules/49/configuring_share.png)
...
![Permissions window for 'Company Data' showing 'Everyone' group with read permission allowed.](https://academy.hackthebox.com/storage/modules/49/share_permissions.png)
...
![Company Data Properties window showing security permissions for SYSTEM, htb-student, and Administrators, with full control allowed for htb-student.](https://academy.hackthebox.com/storage/modules/49/ntfs.png)
...
![Computer Management window showing shared folders, including 'Company Data', with context menu options like expand, manage, and properties.](https://academy.hackthebox.com/storage/modules/49/computer_management.png)
...
![Task Manager showing processes with CPU, memory, disk, and network usage, highlighting Google Chrome and Windows PowerShell.](https://academy.hackthebox.com/storage/modules/49/taskmgr.png)
...
![Resource Monitor displaying processes with memory usage details and physical memory graph.](https://academy.hackthebox.com/storage/modules/49/resource_monitor.png)
...
![Services window showing Windows Update properties with service name, description, and status running.](https://academy.hackthebox.com/storage/modules/49/service_properties.png)
...
![Services window showing Windows Update properties with log on options for Local System account and specific user account.](https://academy.hackthebox.com/storage/modules/49/logon.png)
...
![Windows Update Properties showing recovery options for service failures, including actions like restarting the service or computer.](https://academy.hackthebox.com/storage/modules/49/recovery_screen.png)
...
![Console window with no items displayed, showing Console Root and Actions pane.](https://academy.hackthebox.com/storage/modules/49/MMC.png)

From here, we can browse to File --> `Add or Remove Snap-ins`, and begin customizing our administrative console.

![Add or Remove Snap-ins window showing available snap-ins like ActiveX Control and selected snap-ins as Console Root.](https://academy.hackthebox.com/storage/modules/49/MMC_add_remove.png)
...
![Services snap-in selection window with options to manage local or another computer.](https://academy.hackthebox.com/storage/modules/49/MMC_services.png)
...
![Open dialog showing Windows Administrative Tools folder with management.msc file.](https://academy.hackthebox.com/storage/modules/49/saved_msc.png)
...
![Command prompt showing server configuration options, including domain, computer name, remote management, and update settings.](https://academy.hackthebox.com/storage/modules/49/sconfig.png)
