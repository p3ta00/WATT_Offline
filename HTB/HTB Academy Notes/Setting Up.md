...
![Notion interface showing Acme Inc. workspace with team wiki and policies, displayed on desktop and mobile.](https://academy.hackthebox.com/storage/modules/87/notion.png)
...
![XMind interface showing a mind map with editable topic settings, including shape, fill color, and border options.](https://academy.hackthebox.com/storage/modules/87/xmind.png)

[Obsidian](https://obsidian.md/) is a powerful knowledge base that works on top of a local folder of plain text Markdown files.

![Visual Studio Code showing Foam roadmap with tasks, markdown links, and preview pane.](https://academy.hackthebox.com/storage/modules/87/obsidian.png)
...
![Ghostwriter dashboard showing navigation menu, welcome message, and calendar for March 7-13, 2021.](https://academy.hackthebox.com/storage/modules/87/ghostwriter.png)

#### Pwndoc

![Pwndoc interface showing sections for general information, network scan, and findings, with fields for penetration test details.](https://academy.hackthebox.com/storage/modules/87/pwndoc.png)
...
![GIF showcasing the usage of Flameshot.](https://raw.githubusercontent.com/flameshot-org/flameshot/master/data/img/preview/animatedUsage.gif)
...
![GIF showcasing the usage of Peek.](https://raw.githubusercontent.com/phw/peek/master/data/screenshots/peek-recording-itself.gif)
...
![VMware Workstation 16 Pro interface showing options to create or open a virtual machine and connect to a remote server, with virtual desktops of Ubuntu and Windows 10 in the background.](https://academy.hackthebox.com/storage/modules/87/WS-Blog-Header-vmware.png)
...
![Diagram comparing virtual machines and containers: VMs have separate guest OS for each app, while containers share the OS with isolated apps.](https://wiki.geant.org/download/attachments/184549510/containers-vs-virtual-machines.jpg?version=1&modificationDate=1607437321973&api=v2)
...
![Diagram of Docker Swarm with Vagrant and VirtualBox on host, connecting to registry and three Windows servers (sw-win-01, sw-win-02, sw-win-03) with Docker.](https://stefanscherer.github.io/content/images/2016/03/windows_swarm_demo.png)
...
![VMware Workstation Player 16 installation screen with options to use a physical drive or ISO image, showing an error for undetected OS in the selected ISO.](https://academy.hackthebox.com/storage/modules/87/linux_vmware1.png)
...
![VMware Workstation Player 16 guest OS selection screen with options for Microsoft Windows, Linux, and Other; Linux selected with Debian 10.x 64-bit version.](https://academy.hackthebox.com/storage/modules/87/linux_vmware2.png)
...
![VMware Workstation Player 16 screen for naming a virtual machine, showing 'ParrotOS' as the name and its location path.](https://academy.hackthebox.com/storage/modules/87/linux_vmware3.png)
...
![VMware Workstation Player 16 disk size settings: maximum 20,000 GB, recommended 20 GB for Debian 10.x, option to store as single or multiple files.](https://academy.hackthebox.com/storage/modules/87/linux_vmware4.png)
...
![Parrot Security 5.0.1 boot menu with options: Try/Install, Advanced Modes, Failsafe Modes.](https://academy.hackthebox.com/storage/modules/87/parrot5_install.png)
...
![Parrot OS 5.0 Calamares installer welcome screen with language selection and space-themed background.](https://academy.hackthebox.com/storage/modules/87/parrot5_1.png)
...
![Parrot OS installer partition screen with options to erase disk or manual partitioning, showing 30 GiB storage, encryption enabled.](https://academy.hackthebox.com/storage/modules/87/parrot5_2.png)
...
![Parrot OS installer user setup screen with fields for name, login, computer name, and password, showing 'Cry0l1t3' and 'parrotos' entered.](https://academy.hackthebox.com/storage/modules/87/parrot5_3.png)
...
![Parrot OS unlock screen prompting to unlock disk sda5_crypt.](https://academy.hackthebox.com/storage/modules/87/linux_vmware_installed1.png)
...
![Parrot OS login screen with username 'cry0l1t3' and password field.](https://academy.hackthebox.com/storage/modules/87/linux_vmware_installed2.png)
...
![VMware interface showing ParrotOS tab with options to start guest OS and edit settings, highlighted by a red arrow.](https://academy.hackthebox.com/storage/modules/87/vm_snapshot.png)

#### Completed Tasks

![Snapshot interface for ParrotOS with name 'Initial Setup' and description of completed tasks: updated, tools installed, repos installed.](https://academy.hackthebox.com/storage/modules/87/vm_snapshot3.png)
...
![VMware interface showing ParrotOS with options to start guest OS and edit settings, highlighted by a red box.](https://academy.hackthebox.com/storage/modules/87/vm_encrypt0.png)
...
![VMware Virtual Machine Settings showing options for encryption, with 'Access Control' not encrypted and a prompt to set a password.](https://academy.hackthebox.com/storage/modules/87/vm_encrypt1.png)
...
![ParrotOS encrypted VM password entry screen, prompting for password to continue.](https://academy.hackthebox.com/storage/modules/87/linux_vmware_encrypted.png)
...
![Terminal showing command 'uname -a' output with Linux version details on Windows PowerShell.](https://academy.hackthebox.com/storage/modules/87/terminal-example.png)
...
![Terminal showing bash prompt in Windows PowerShell with instructions for using 'sudo' for admin commands](https://academy.hackthebox.com/storage/modules/87/windows-bash.png)
