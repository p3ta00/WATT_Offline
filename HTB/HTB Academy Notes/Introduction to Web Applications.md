...
![Dashboard showing 932 online players, 1032 machine owns, 622 challenge owns, and recent activity with targets Lame, Emdee five for life, and Delivery.](https://academy.hackthebox.com/storage/modules/75/htb-web-app_1.jpg)
...
![Comparison of website and web app: Website has static pages, same for everyone; Web app has dynamic, interactive pages, different for each user.](https://academy.hackthebox.com/storage/modules/75/website_vs_webapps.jpg)
...
![Diagram showing a server connected to four clients: desktop, laptop, smartphone, and monitor.](https://academy.hackthebox.com/storage/modules/75/client-server-model.jpg)
...
![Diagram showing a server connected to three clients: smartphone, laptop, and monitor.](https://academy.hackthebox.com/storage/modules/75/one-server-arch.jpg)
...
![Diagram showing a database connected to three servers, each linked to a smartphone, laptop, and monitor client.](https://academy.hackthebox.com/storage/modules/75/many-server-one-db-arch.jpg)
...
![Diagram showing three databases connected to three servers, each linked to a smartphone, laptop, and monitor client.](https://academy.hackthebox.com/storage/modules/75/many-server-many-db-arch.jpg)
...
![ASP.NET Core architecture diagram showing client, IIS reverse proxy, ASP.NET Core web app with filters and services, connected to data sources, identity providers, and third-party services.](https://docs.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/media/image5-12.png)
...
![Browser window displaying HTML, CSS, and JS code snippets for a webpage layout.](https://academy.hackthebox.com/storage/modules/75/frontend-components.jpg)
...
![Apache logo with a feather.](https://academy.hackthebox.com/storage/modules/75/apache.png)
...
![NGINX logo.](https://academy.hackthebox.com/storage/modules/75/nginx.png)
...
![Microsoft IIS logo.](https://academy.hackthebox.com/storage/modules/75/iis.png)
